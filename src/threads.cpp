...
/// Since a region takes either one thread or the whole pool, the bar it has to clear is
/// this times the pool: below that, the barrier costs more than the work it divides.
