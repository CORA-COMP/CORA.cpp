...
// `threads_for` narrows an individual region to the work it actually has.
...
/// `work` scalar operations: never more than there are iterations, and one when the work
/// is too small to pay for a fan-out.
